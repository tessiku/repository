...
class d1_5 extends StatefulWidget {
  const d1_5({Key? key}) : super(key: key);

  @override
  _d1_5State createState() => _d1_5State();
}

class _d1_5State extends State<d1_5> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('donnees de 2015'),
      ),
      body: FutureBuilder<QuerySnapshot<Map<String, dynamic>>>(
        future: _tabRef.where("Annee", isEqualTo: 2015).get(),
